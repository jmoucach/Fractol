...
void	draw_order(t_data *data)
{
	...
	pos[0] = (t_pos){200 + 0, 600 + -150};//A
	pos[1] = (t_pos){200 + 130, 600 + -75};//E
	pos[2] = (t_pos){200 + 130, 600 + 5};//Q
	pos[3] = (t_pos){200 + 130, 600 + 75};//G
	pos[4] = (t_pos){200+ 0, 600 + 150};//B
	pos[5] = (t_pos){200 + -75, 600 + 107};//S
	pos[6] = (t_pos){200 + -130, 600 + 75};//F
	pos[7] = (t_pos){200 + -130, 600 + -75};//D
	pos[8] = (t_pos){200 + -56, 600 + -117};//R
	pos[9] = (t_pos){200 + 0, 600 + -83};//O
	pos[10] = (t_pos){200 + 75, 600 + -42};//K
	pos[11] = (t_pos){200 + 75, 600 + 39};//P
	pos[12] = (t_pos){200 + 0, 600 + 85};//L
	pos[13] = (t_pos){200 + -75, 600 + 42};//N
	pos[14] = (t_pos){200 + -75, 600 + -42};//M
	order(pos, data);
}
