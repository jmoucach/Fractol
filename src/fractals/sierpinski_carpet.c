...
void	divide_carpet(t_data *data, t_pos p1, t_pos p2, int lvl)
{
	...
	else
	{
			...
			divide_carpet(data,(t_pos){(p1.x + 2 * p2.x) / 3.0, (2 * p1.y + p2.y) / 3.0}, (t_pos)
				{p2.x         , (p1.y + 2 * p2.y) / 3.0}, lvl - 1);
			divide_carpet(data,(t_pos){p1.x         , (p1.y + 2 * p2.y) / 3.0}, (t_pos)
				{(2 * p1.x + p2.x) / 3.0,  p2.y}, lvl - 1);
			divide_carpet(data,(t_pos){(2 * p1.x + p2.x) / 3.0, (p1.y + 2 * p2.y) / 3.0}, (t_pos)
				{(p1.x + 2 * p2.x) / 3.0,  p2.y}, lvl - 1);
			divide_carpet(data,(t_pos){(p1.x + 2 * p2.x) / 3.0, (p1.y + 2 * p2.y) / 3.0}, (t_pos)
				{p2.x, p2.y}, lvl - 1);
	}
